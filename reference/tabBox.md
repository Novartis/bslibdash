...
#>       <ul class="nav nav-tabs shiny-tab-input card-header-tabs" id="quarterly" data-tabsetid="4050">
#>         <li class="active">
#>           <a href="#tab-4050-1" data-toggle="tab" data-bs-toggle="tab" data-value="Q1">Q1</a>
#>         </li>
#>         <li>
#>           <a href="#tab-4050-2" data-toggle="tab" data-bs-toggle="tab" data-value="Q2">Q2</a>
#>         </li>
#>       </ul>
#>     </div>
#>     <div class="tab-content html-fill-item html-fill-container" data-tabsetid="4050">
#>       <div class="tab-pane active html-fill-item html-fill-container bslib-gap-spacing" data-value="Q1" id="tab-4050-1" style="gap:0;padding:0;">
#>         <div class="card-body bslib-gap-spacing html-fill-item html-fill-container" style="margin-top:auto;margin-bottom:auto;flex:1 1 auto;">
#>           <p>Q1 content</p>
#>         </div>
#>       </div>
#>       <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Q2" id="tab-4050-2" style="gap:0;padding:0;">
#>         <div class="card-body bslib-gap-spacing html-fill-item html-fill-container" style="margin-top:auto;margin-bottom:auto;flex:1 1 auto;">
#>           <p>Q2 content</p>
#>         </div>
#>       </div>
...
#>       <ul class="nav nav-tabs card-header-tabs" data-tabsetid="9439">
#>         <li>
#>           <a href="#tab-9439-1" data-toggle="tab" data-bs-toggle="tab" data-value="Q1">Q1</a>
#>         </li>
#>         <li class="active">
#>           <a href="#tab-9439-2" data-toggle="tab" data-bs-toggle="tab" data-value="Q2">Q2</a>
#>         </li>
#>       </ul>
#>     </div>
#>     <div class="tab-content html-fill-item html-fill-container" data-tabsetid="9439">
#>       <div class="tab-pane html-fill-item html-fill-container bslib-gap-spacing" data-value="Q1" id="tab-9439-1" style="gap:0;padding:0;">
#>         <div class="card-body bslib-gap-spacing html-fill-item html-fill-container" style="margin-top:auto;margin-bottom:auto;flex:1 1 auto;">
#>           <p>Q1 content</p>
#>         </div>
#>       </div>
#>       <div class="tab-pane active html-fill-item html-fill-container bslib-gap-spacing" data-value="Q2" id="tab-9439-2" style="gap:0;padding:0;">
#>         <div class="card-body bslib-gap-spacing html-fill-item html-fill-container" style="margin-top:auto;margin-bottom:auto;flex:1 1 auto;">
#>           <p>Q2 content</p>
#>         </div>
#>       </div>
