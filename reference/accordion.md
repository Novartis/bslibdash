...
#>         <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#bslib-accordion-panel-4114" aria-controls="bslib-accordion-panel-4114" aria-expanded="true">
#>           <div class="accordion-icon"></div>
#>           <div class="accordion-title">Date range</div>
#>         </button>
#>       </div>
#>       <div id="bslib-accordion-panel-4114" class="accordion-collapse collapse show">
...
#>       <div class="accordion-header">
#>         <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bslib-accordion-panel-2802" aria-expanded="false" aria-controls="bslib-accordion-panel-2802">
#>           <div class="accordion-icon"></div>
#>           <div class="accordion-title">Region</div>
#>         </button>
#>       </div>
#>       <div id="bslib-accordion-panel-2802" class="accordion-collapse collapse">
#>         <div class="accordion-body">
#>           <p>All regions</p>
#>         </div>
#>       </div>
...
#>   <div class="accordion-header">
#>     <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bslib-accordion-panel-1948" aria-expanded="false" aria-controls="bslib-accordion-panel-1948">
#>       <div class="accordion-icon"></div>
#>       <div class="accordion-title">Advanced settings</div>
#>     </button>
#>   </div>
#>   <div id="bslib-accordion-panel-1948" class="accordion-collapse collapse">
#>     <div class="accordion-body">
